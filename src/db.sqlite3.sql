...
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 1,"Fehu","Simboliza riquezas materiais, sucesso e vitoria." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 1);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 2,"Uruz","Sorte, crescimento, perseveranca e progresso." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 2);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 3,"Thurisaz","Protecao divina e entusiasmo." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 3);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 4,"Ansuz","Sabedoria, inspiracao e ouvir bons conselhos." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 4);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 5,"Raidho","Viagem, progresso em direcao às metas." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 5);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 6,"Kenaz","Renovacao, novos comecos e iluminacao." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 6);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 7,"Gebo","Uniao, equilibrio e bons negocios." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 7);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 8,"Wunjo","Bem-estar e evolucao positiva." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 8);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 9,"Hagalaz","Simboliza precaucoes, obstaculos e adiamento de planos." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 9);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 10,"Naudhiz","Limitacoes e cautela com planos." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 10);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 11,"Isa","Concentracao, paciencia e equilibrio." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 11);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 12,"Jera","Recompensas, alegria e satisfacao." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 12);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 13,"Eihwaz","Protecao, final de um ciclo e recomeco." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 13);
...
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 15,"Sowelo","Autoconhecimento, regeneracao, sucesso e vitoria." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 15);
...
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 17,"Tiwaz","Simboliza vitorias, honra e justica." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 17);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 18,"Berkana","Renovacao." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 18);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 19,"Ehwaz","Mudancas, progresso e lealdade." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 19);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 20,"Mannaz","Integridade, fe e clareza espiritual." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 20);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 21,"Laguz","Intuicao e poderes psiquicos." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 21);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 22,"Inguz","Realizacoes, nascimentos, amor e sexualidade." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 22);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 23,"Dagaz","Prosperidade, transformacoes positivas." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 23);
INSERT INTO "TRuneInfo" ("id_runeinfo","name","description") SELECT 24,"Othila","Sabedoria ancestral, dominio, noticias distantes." WHERE NOT EXISTS (SELECT 1 FROM TRuneInfo WHERE id_runeinfo = 24);
